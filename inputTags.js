(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: 'كن حذرا ، لا يمكنك إضافة علامة فارغة.',
            minLength: 'كن حذرًا ، يجب أن تحتوي علامتك على%s من الأحرف على الأقل.',
            maxLength: 'كن حذرًا ، يجب ألا تتجاوز علامتك%s الشخصيات.',
            max: 'يرجى ملاحظة أن عدد العلامات يجب ألا يتجاوز %s.',
            email: 'يرجى ملاحظة أن عنوان البريد الإلكتروني الذي أدخلته غير صالح',
            exists: 'انتبه ، هذه العلامة موجودة بالفعل!',
            autocomplete_only: 'يرجى ملاحظة أنه يجب عليك تحديد قيمة من القائمة.',
            timeout: 8000
        }
    };
